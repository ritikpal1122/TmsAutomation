...
> **Source**: [https://www.testmuai.com/support/docs/kaneai-ci-cd-automation](https://www.testmuai.com/support/docs/kaneai-ci-cd-automation)

**Product**: KaneAI

**Last Crawled**: 2026-01-27T20:47:18.518124
...
## Prerequisites[â](https://www.testmuai.com/support/docs/kaneai-ci-cd-automation#prerequisites "Direct link to Prerequisites")

  * Access to Test Manager.
  * A project with KaneAI-generated test cases.
  * Credentials for TestMu AI platform.

## Step-by-Step Guide[â](https://www.testmuai.com/support/docs/kaneai-ci-cd-automation#step-by-step-guide "Direct link to Step-by-Step Guide")

### Step 1: Navigate to the Test Manager[â](https://www.testmuai.com/support/docs/kaneai-ci-cd-automation#step-1-navigate-to-the-test-manager "Direct link to Step 1: Navigate to the Test Manager")

  * Log in to the KaneAI platform and go to the Test Manager page.
  * Access the project where the test run is located.

![Image](https://www.testmuai.com/support/assets/images/step1-203d6cdadf6419ba09691b6d7763242a.png)

### Step 2: Locate the 'Test Runs' Section & Copy Test run ID[â](https://www.testmuai.com/support/docs/kaneai-ci-cd-automation#step-2-locate-the-test-runs-section--copy-test-run-id "Direct link to Step 2: Locate the 'Test Runs' Section & Copy Test run ID")
...
### Step 3: Configure the API Call[â](https://www.testmuai.com/support/docs/kaneai-ci-cd-automation#step-3-configure-the-api-call "Direct link to Step 3: Configure the API Call")
...
Replace `<TestRunID>` with the actual ID from the URL and set additional optional parameters:
  ...
  * **tunnel** : Add the parameter and tunnel name if you want to run using TestMu AI Tunnel for private applications. See more details for tunnel [here](https://www.testmuai.com/support/docs/kane-ai-geolocation-tunnel-proxy/#tunnel-support).
  ...
  * **geolocation** : Add the resgion of the geolocation that you want to run your tests from. You can find the list of support geolocations [here](https://www.testmuai.com/support/docs/selenium-geolocation-capabilities/).
  * **environment_id** : Define the environment on which you want to run the test run if required.
  * **retry_on_failure** : Define whether to retry if the [testRunnerCommand](https://www.testmuai.com/support/docs/deep-dive-into-hyperexecute-yaml/#testrunnercommand) execution fails. If "retry_on_failure" is false, the default max retries will still be 1. You can find more details [here](https://www.lambdatest.com/support/docs/deep-dive-into-hyperexecute-yaml/#retryonfailure).
  * **max_retries** : Define the number of maximum retries you want (Max value 5). Default retries 1. You can find more details [here](https://www.testmuai.com/support/docs/deep-dive-into-hyperexecute-yaml/#maxretries).
  * **timezone** : Define the timezone you want to choose for test run in UTC+01:00 format.
  * **app_profiling** : Add true if you want to track app profiling metrics in your test. You can find more details [here](https://www.testmuai.com/support/docs/appium-app-performance-analytics/).
  * **performance** : Add true if you want generate Lighthouse report for your web tests. Supported on limited OS browser combinations. Additionally, Setting this as true could potentially slow down the execution time. You can find more details [here](https://www.testmuai.com/support/docs/view-lighthouse-performance-metrics/).
...
#### Example API Call:[â](https://www.testmuai.com/support/docs/kaneai-ci-cd-automation#example-api-call "Direct link to Example API Call:")
...
#### Sample API Response:[â](https://www.testmuai.com/support/docs/kaneai-ci-cd-automation#sample-api-response "Direct link to Sample API Response:")
...
### Step 4: Authenticate and Trigger the Job[â](https://www.testmuai.com/support/docs/kaneai-ci-cd-automation#step-4-authenticate-and-trigger-the-job "Direct link to Step 4: Authenticate and Trigger the Job")
...
### Step 5: Monitor Test Executions[â](https://www.testmuai.com/support/docs/kaneai-ci-cd-automation#step-5-monitor-test-executions "Direct link to Step 5: Monitor Test Executions")
...
![Image](https://www.testmuai.com/support/assets/images/image7-fe7b3ab3cb042631f4499eac1fa79346.png)

## GithubActions sample[â](https://www.testmuai.com/support/docs/kaneai-ci-cd-automation#githubactions-sample "Direct link to GithubActions sample")

Here is a sample that you can use on how to integrate the API with GithubActions in your Github repository:

**Step 1: Create a GitHub Actions Workflow YAML File** In your Git repository, navigate to .github/workflows/ and create a file named sanity-test.yml.

**Step 2: Sample for yml file** In below sample, we are executing a test run using test_run_id and then verifying the result for it using HyperExecute job status API. You can find more details on HyperExecute APIs [here](https://www.lambdatest.com/support/api-doc/?key=hyperexecute) and update the API in the .yml file based on your needs.
...
**Step 3: Define Workflow Triggers** Set the workflow to trigger on push and pull_request events (you can modify the trigger based on your needs) under "on" section of the yaml above.

## Video Explanation[â](https://www.testmuai.com/support/docs/kaneai-ci-cd-automation#video-explanation "Direct link to Video Explanation")
