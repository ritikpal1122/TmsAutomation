...
> **Source**: [https://www.testmuai.com/support/docs/kane-ai-command-guide](https://www.testmuai.com/support/docs/kane-ai-command-guide)

**Product**: KaneAI

**Last Crawled**: 2026-01-27T20:47:24.680860
...
## Navigation & Page Interaction[â](https://www.testmuai.com/support/docs/kane-ai-command-guide#navigation--page-interaction "Direct link to Navigation & Page Interaction")
...
Type Text| `enter "[[email protected]](https://www.testmuai.com/cdn-cgi/l/email-protection)"` , `type "password123"`  
...
## Waits & Timeouts[â](https://www.testmuai.com/support/docs/kane-ai-command-guide#waits--timeouts "Direct link to Waits & Timeouts")
...
![](https://www.testmuai.com/support/assets/images/select_set_timeout-7e0fa330d981c5dc466b609c92aeb1e9.webp)

* * *

## Tab Management[â](https://www.testmuai.com/support/docs/kane-ai-command-guide#tab-management "Direct link to Tab Management")

KaneAI makes it easy to manage browser tabs during automated tests, whether youâre opening new tabs, switching between them, or closing them. Here's how to control your tabs with simple commands:
...
To open a new tab in your browser, use the following command:
  ...
  * **IMPORTANT:** Highlight that even when a new tab is open, we need to explicitly switch context of the application to that new tab by adding an instruction for âSwitch to Amazon tabâ or âSwitch to 2nd tabâ
...
You can close tabs either by position or by name when you're done with them:
  ...
  * **Close Lambdatest tab:** Closes the tab named "Lambdatest". This is useful when youâve finished interacting with a specific page and want to clean up the session.
...
**Tips for Managing Tabs**
  ...
  * When switching tabs, be sure the tab is open before using a **switch** command. If the tab doesnât exist or has already been closed, the command will fail.
...
## Scrolling Commands[â](https://www.testmuai.com/support/docs/kane-ai-command-guide#scrolling-commands "Direct link to Scrolling Commands")

KaneAI allows you to easily control scrolling behavior on your web pages. Hereâs how you can scroll to elements, pages, or specific sections:
...
## Assertions[â](https://www.testmuai.com/support/docs/kane-ai-command-guide#assertions "Direct link to Assertions")
...
Category| Example  
---|---  
**Driver Assertions**|  Validate **browser state** ( current URL, window dimensions).

  * Example: Assert if current URL is `https://example.com`
  * Validate window height and width

  
**Text Assertions**|  Check for **presence/absence of text**.

  * Example: Assert âWelcome Back!â is visible
  * Example: Assert error message âInvalid passwordâ is displayed

  
**Visual Assertions**|  Confirm **image or logo visibility**.

  * Example: Assert company logo appears in header
  * Example: Assert product image is visible

  
**Relative Assertions**|  Validate **element relationships**.

  * Example: Assert login button is in same column as username
  * Example: Assert submit & cancel buttons are in same row

  
**Mathematical Assertions**|  Check **numeric calculations**.

  * Example: Assert `3 + 4 = 7`
...
Older tests may still use _warn-and-continue_ until edited.  
More info: [Failure Conditions](https://www.testmuai.com/support/docs/kaneai-failure-conditions)

* * *

## Unsupported Assertions (Coming Soon)[â](https://www.testmuai.com/support/docs/kane-ai-command-guide#unsupported-assertions-coming-soon "Direct link to Unsupported Assertions \(Coming Soon\)")
...
## Query Information[â](https://www.testmuai.com/support/docs/kane-ai-command-guide#query-information "Direct link to Query Information")
...
## Conditional Actions[â](https://www.testmuai.com/support/docs/kane-ai-command-guide#conditional-actions "Direct link to Conditional Actions")
...
**Conditional Click** Example: **if pop up is present in the viewport then click on it** : clicks on a pop-up element if it is visible within the current view.

**Conditional Selection** Example: **if price < 200 then click add to cart else select second product**: selects an action based on the price condition. If the price is less than $200, it adds the item to the cart. Otherwise, it selects the second product.

* * *

## Do's and Don'ts[â](https://www.testmuai.com/support/docs/kane-ai-command-guide#dos-and-donts "Direct link to Do's and Don'ts")

Follow these examples for better clarity and performance during test writing:

**Do (Good Example)**| **Donât (Bad Example)**  
---|---  
`Assert text "Submit" on form footer is visible`| `Assert that the submit button works and the layout is correct`  
`Assert textbox contains the exact value 'heading1'`| `Assert the textbox has heading` (vague, unclear what âheadingâ refers to)  
...
`Assert the divider looks red`| `Assert divider color is #ff5733` (too detailâspecific, fragile visual check)  
...
**Key Takeaways:**
  ...
  * **Donât mix actions with assertions:** Keep actions (like waiting for an element) separate from assertions.
...
## Best Practices[â](https://www.testmuai.com/support/docs/kane-ai-command-guide#best-practices "Direct link to Best Practices")
