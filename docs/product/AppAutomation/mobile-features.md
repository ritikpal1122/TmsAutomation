...
> **See [AppAutomationMain.md](AppAutomationMain.md) for the complete crawled documentation index with 26 feature pages.**

### Available Crawled Documentation Categories

| Category | Key Documents |
|----------|---------------|
| **Getting Started** | [Getting Started with Appium](getting-started-with-appium-testing.md), [Desired Capabilities](desired-capabilities-in-appium.md), [Languages & Frameworks](appium-languages-and-frameworks.md) |
| **Appium - Java** | [Java](appium-java.md), [TestNG](appium-java-testng.md), [JUnit](appium-java-junit.md), [Cucumber](appium-java-cucumber.md), [JBehave](appium-java-jbehave.md) |
| **Appium - Python** | [Python](appium-python.md), [Pytest](appium-python-pytest.md), [Behave](appium-python-behave.md), [Robot](appium-python-robot.md), [Gauge](appium-python-gauge.md) |
| **Appium - JavaScript** | [Node.js](appium-nodejs.md), [Mocha](appium-nodejs-mocha.md), [WebDriverIO](appium-nodejs-webdriverio.md) |
| **Appium - Other Languages** | [C#](appium-csharp.md), [NUnit](appium-csharp-nunit.md), [Ruby](appium-ruby.md), [RSpec](appium-ruby-rspec.md), [Ruby Cucumber](appium-ruby-cucumber.md), [PHP](appium-php.md), [Behat](appium-php-behat.md) |
| **Native Frameworks** | [Espresso Testing](getting-started-with-espresso-testing.md), [XCUITest](getting-started-with-xcuitest.md), [Flutter Dart](getting-started-with-flutter-dart-android-automation.md) |
