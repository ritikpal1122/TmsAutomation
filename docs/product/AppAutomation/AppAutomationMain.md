# App Automation Documentation

> **Auto-generated index for App Automation features and documentation.**
...
|---|---------|-------------|------|
| 1 | [Appium With Cucumber](appium-java-cucumber.md) | Real Device Virtual Device | [Source](https://www.testmuai.com/support/docs/appium-java-cucumber) |
| 2 | [Appium With JBehave](appium-java-jbehave.md) | Real Device Virtual Device | [Source](https://www.testmuai.com/support/docs/appium-java-jbehave) |
| 3 | [Appium With JUnit](appium-java-junit.md) | Real Device Virtual Device | [Source](https://www.testmuai.com/support/docs/appium-java-junit) |
| 4 | [Appium With Mocha](appium-nodejs-mocha.md) | Real Device Virtual Device | [Source](https://www.testmuai.com/support/docs/appium-nodejs-mocha) |
| 5 | [Appium With TestNG](appium-java-testng.md) | Real Device Virtual Device | [Source](https://www.testmuai.com/support/docs/appium-java-testng) |
| 6 | [Appium With WebDriverIO](appium-nodejs-webdriverio.md) | Real Device Virtual Device | [Source](https://www.testmuai.com/support/docs/appium-nodejs-webdriverio) |
| 7 | [Appium with Behat](appium-php-behat.md) | In this documentation, you will learn how to trigger a automation script of **Behat** for applicatio... | [Source](https://www.testmuai.com/support/docs/appium-php-behat) |
| 8 | [Appium with Behave](appium-python-behave.md) | Real Device Virtual Device | [Source](https://www.testmuai.com/support/docs/appium-python-behave) |
| 9 | [Appium with C#](appium-csharp.md) | Real Device Virtual Device | [Source](https://www.testmuai.com/support/docs/appium-csharp) |
| 10 | [Appium with Cucumber](appium-ruby-cucumber.md) | Real Device Virtual Device | [Source](https://www.testmuai.com/support/docs/appium-ruby-cucumber) |
| 11 | [Appium with Gauge](appium-python-gauge.md) | Real Device Virtual Device | [Source](https://www.testmuai.com/support/docs/appium-python-gauge) |
| 12 | [Appium with Java](appium-java.md) | Real Device Virtual Device | [Source](https://www.testmuai.com/support/docs/appium-java) |
| 13 | [Appium with NUnit](appium-csharp-nunit.md) | Real Device Virtual Device | [Source](https://www.testmuai.com/support/docs/appium-csharp-nunit) |
| 14 | [Appium with Nodejs](appium-nodejs.md) | Real Device Virtual Device | [Source](https://www.testmuai.com/support/docs/appium-nodejs) |
| 15 | [Appium with PHP](appium-php.md) | Real Device Virtual Device | [Source](https://www.testmuai.com/support/docs/appium-php) |
| 16 | [Appium with Pytest](appium-python-pytest.md) | Real Device Virtual Device | [Source](https://www.testmuai.com/support/docs/appium-python-pytest) |
| 17 | [Appium with Python](appium-python.md) | Real Device Virtual Device | [Source](https://www.testmuai.com/support/docs/appium-python) |
| 18 | [Appium with Robot](appium-python-robot.md) | Real Device Virtual Device | [Source](https://www.testmuai.com/support/docs/appium-python-robot) |
| 19 | [Appium with Rspec](appium-ruby-rspec.md) | Real Device Virtual Device | [Source](https://www.testmuai.com/support/docs/appium-ruby-rspec) |
| 20 | [Appium with Ruby](appium-ruby.md) | Real Device Virtual Device | [Source](https://www.testmuai.com/support/docs/appium-ruby) |
| 21 | [Desired Capabilities](desired-capabilities-in-appium.md) | Real Device Virtual Device | [Source](https://www.testmuai.com/support/docs/desired-capabilities-in-appium) |
| 22 | [Espresso Testing On TestMu AI](getting-started-with-espresso-testing.md) | Espresso is a widely-used testing framework for Android, designed to simplify the process of writing... | [Source](https://www.testmuai.com/support/docs/getting-started-with-espresso-testing) |
| 23 | [Flutter Dart Testing On TestMu AI - Android](getting-started-with-flutter-dart-android-automation.md) | Flutter, an open-source UI toolkit created by Google, is a popular choice among developers to build ... | [Source](https://www.testmuai.com/support/docs/getting-started-with-flutter-dart-android-automation) |
| 24 | [Getting Started with Appium Testing](getting-started-with-appium-testing.md) | Appium is an open-source framework that allows you to automate tests for mobile applications. It wor... | [Source](https://www.testmuai.com/support/docs/getting-started-with-appium-testing) |
| 25 | [Supported Languages And Frameworks](appium-languages-and-frameworks.md) | Here is a list of languages and frameworks that are supported by the TestMu AI to run Appium automat... | [Source](https://www.testmuai.com/support/docs/appium-languages-and-frameworks) |
| 26 | [XCUI Testing on TestMu AI](getting-started-with-xcuitest.md) | Real Device Virtual Device | [Source](https://www.testmuai.com/support/docs/getting-started-with-xcuitest) |

---

## Quick Links

- [Appium With Cucumber](appium-java-cucumber.md)
- [Appium With JBehave](appium-java-jbehave.md)
- [Appium With JUnit](appium-java-junit.md)
- [Appium With Mocha](appium-nodejs-mocha.md)
- [Appium With TestNG](appium-java-testng.md)
- [Appium With WebDriverIO](appium-nodejs-webdriverio.md)
- [Appium with Behat](appium-php-behat.md)
- [Appium with Behave](appium-python-behave.md)
- [Appium with C#](appium-csharp.md)
- [Appium with Cucumber](appium-ruby-cucumber.md)
- [Appium with Gauge](appium-python-gauge.md)
- [Appium with Java](appium-java.md)
- [Appium with NUnit](appium-csharp-nunit.md)
- [Appium with Nodejs](appium-nodejs.md)
- [Appium with PHP](appium-php.md)
- [Appium with Pytest](appium-python-pytest.md)
- [Appium with Python](appium-python.md)
- [Appium with Robot](appium-python-robot.md)
- [Appium with Rspec](appium-ruby-rspec.md)
- [Appium with Ruby](appium-ruby.md)
- [Desired Capabilities](desired-capabilities-in-appium.md)
- [Espresso Testing On TestMu AI](getting-started-with-espresso-testing.md)
- [Flutter Dart Testing On TestMu AI - Android](getting-started-with-flutter-dart-android-automation.md)
- [Getting Started with Appium Testing](getting-started-with-appium-testing.md)
- [Supported Languages And Frameworks](appium-languages-and-frameworks.md)
- [XCUI Testing on TestMu AI](getting-started-with-xcuitest.md)
...
- [App Automation Overview](https://www.testmuai.com/support/docs/getting-started-with-xcuitest)
...
|---------|----------------|
| **Device Infrastructure** | Real devices (3000+), virtual devices (emulators/simulators) |
| **Automation Frameworks** | Appium, Espresso, XCUITest, Flutter, Maestro, Detox |
| **App Management** | App upload, versioning, app settings |
| **Device Capabilities** | OS versions, brands, orientations, network conditions |
| **Advanced Features** | Camera/video injection, biometrics, geolocation, SIM support |
| **Sharding** | Manual and auto sharding via HyperExecute |
| **Debugging** | Logs, screenshots, video recording, network logs |
