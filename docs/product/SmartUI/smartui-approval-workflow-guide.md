...
> **Source**: [https://www.testmuai.com/support/docs/smartui-approval-workflow-guide](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide)

**Product**: SmartUI

**Last Crawled**: 2026-01-27T21:04:06.443107
...
## Core Functions Explained[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#core-functions-explained "Direct link to Core Functions Explained")

### Approve Function[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#approve-function "Direct link to Approve Function")
...
### Reject Function[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#reject-function "Direct link to Reject Function")
...
### Move to Baseline Function[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#move-to-baseline-function "Direct link to Move to Baseline Function")
...
### Merge Function[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#merge-function "Direct link to Merge Function")
...
## Workflow Types and Baseline Management[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#workflow-types-and-baseline-management "Direct link to Workflow Types and Baseline Management")

### CLI-Based Workflows (Explicit User Control)[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#cli-based-workflows-explicit-user-control "Direct link to CLI-Based Workflows \(Explicit User Control\)")
...
**Required Actions** :
  ...
  1. Run build â Compare against baseline
  2. Review differences â Approve valid changes
...
### Hooks/API/PDF Workflows (Capability-Driven)[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#hooksapipdf-workflows-capability-driven "Direct link to Hooks/API/PDF Workflows \(Capability-Driven\)")
...
### Git-Integrated Projects (Branch-Based Automation)[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#git-integrated-projects-branch-based-automation "Direct link to Git-Integrated Projects \(Branch-Based Automation\)")
...
## Deep Dive: How Baseline Updates Actually Work[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#deep-dive-how-baseline-updates-actually-work "Direct link to Deep Dive: How Baseline Updates Actually Work")

### The Baseline Reference System[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#the-baseline-reference-system "Direct link to The Baseline Reference System")
...
### Explicit User Action Requirements[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#explicit-user-action-requirements "Direct link to Explicit User Action Requirements")
...
## Common Customer Confusion Scenarios[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#common-customer-confusion-scenarios "Direct link to Common Customer Confusion Scenarios")

### Scenario 1: "I approved B1, why isn't it the baseline for B5?"[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#scenario-1-i-approved-b1-why-isnt-it-the-baseline-for-b5 "Direct link to Scenario 1: "I approved B1, why isn't it the baseline for B5?"")
...
### Scenario 2: "I approved and moved SS3 from B3 and SS4 from B4 to B2, but B5 shows SS1 as new"[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#scenario-2-i-approved-and-moved-ss3-from-b3-and-ss4-from-b4-to-b2-but-b5-shows-ss1-as-new "Direct link to Scenario 2: "I approved and moved SS3 from B3 and SS4 from B4 to B2, but B5 shows SS1 as new"")
...
### Scenario 3: "I set smartUI.baseline=true, but baseline didn't update"[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#scenario-3-i-set-smartuibaselinetrue-but-baseline-didnt-update "Direct link to Scenario 3: "I set smartUI.baseline=true, but baseline didn't update"")
...
## Ideal Usage Guidelines[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#ideal-usage-guidelines "Direct link to Ideal Usage Guidelines")

### For CLI Workflows[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#for-cli-workflows "Direct link to For CLI Workflows")
...
### For SDK Integration[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#for-sdk-integration "Direct link to For SDK Integration")
...
### Branch-Based Development[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#branch-based-development "Direct link to Branch-Based Development")
...
## Advanced Baseline Management[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#advanced-baseline-management "Direct link to Advanced Baseline Management")

### Multi-Level Baseline Strategy[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#multi-level-baseline-strategy "Direct link to Multi-Level Baseline Strategy")
...
### Baseline Rollback[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#baseline-rollback "Direct link to Baseline Rollback")
...
## Best Practices[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#best-practices "Direct link to Best Practices")

### 1\. **Understand Your Workflow Type**[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#1-understand-your-workflow-type "Direct link to 1-understand-your-workflow-type")
...
### 2\. **Always Verify Baseline Changes**[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#2-always-verify-baseline-changes "Direct link to 2-always-verify-baseline-changes")
...
### 3\. **Leverage Branch Merging**[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#3-leverage-branch-merging "Direct link to 3-leverage-branch-merging")

  * Use for complex multi-branch workflows
  * Maintain audit trails of merges
  * Plan baseline consolidation carefully

### 4\. **Monitor Baseline Health**[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#4-monitor-baseline-health "Direct link to 4-monitor-baseline-health")

  * Regularly review baseline age and completeness
  * Update baselines after major releases
  * Clean up outdated baselines

### 5\. **Document Decisions**[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#5-document-decisions "Direct link to 5-document-decisions")

  * Add comments when approving/rejecting/moving
  * Maintain change logs for baseline updates
  * Train team on workflow differences

## Troubleshooting Common Issues[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#troubleshooting-common-issues "Direct link to Troubleshooting Common Issues")

### "Baseline not updating after approval"[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#baseline-not-updating-after-approval "Direct link to "Baseline not updating after approval"")

**Cause** : Using CLI workflow without moving to baseline **Solution** : Explicitly use "Move to Baseline" function

### "Screenshots missing from baseline"[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#screenshots-missing-from-baseline "Direct link to "Screenshots missing from baseline"")

**Cause** : Moved screenshots from builds that don't contain all required images **Solution** : Ensure target baseline build has complete screenshot set

### "Unexpected rejections in new builds"[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#unexpected-rejections-in-new-builds "Direct link to "Unexpected rejections in new builds"")

**Cause** : Baseline updated with incomplete or incorrect screenshots **Solution** : Review baseline contents before moving

### "Merge conflicts"[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#merge-conflicts "Direct link to "Merge conflicts"")

**Cause** : Conflicting screenshots between source and target **Solution** : Resolve conflicts manually before merging

### "Capability not working"[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#capability-not-working "Direct link to "Capability not working"")

**Cause** : Incorrect capability syntax or build failure **Solution** : Verify capability format and build status

## Getting Help[â](https://www.testmuai.com/support/docs/smartui-approval-workflow-guide#getting-help "Direct link to Getting Help")

If you encounter issues with baseline management or need clarification on approval workflows:

  * Check the [SmartUI Baseline Management Documentation](https://www.testmuai.com/support/docs/smartui-baseline-management/)
  * Review [Multiselect & Bulk Operations Guide](https://www.testmuai.com/support/docs/smartui-multiselect-bulkops/)
  * Contact support at [[email protected]](https://www.testmuai.com/cdn-cgi/l/email-protection#e2919792928d9096a2968791968f97cc838b)
