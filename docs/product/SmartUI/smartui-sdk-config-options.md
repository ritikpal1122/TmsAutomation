...
> **Source**: [https://www.testmuai.com/support/docs/smartui-sdk-config-options](https://www.testmuai.com/support/docs/smartui-sdk-config-options)

**Product**: SmartUI

**Last Crawled**: 2026-01-27T21:03:56.344290
...
## Configuration File Structure[â](https://www.testmuai.com/support/docs/smartui-sdk-config-options#configuration-file-structure "Direct link to Configuration File Structure")
...
## Configuration Options[â](https://www.testmuai.com/support/docs/smartui-sdk-config-options#configuration-options "Direct link to Configuration Options")
...
An array of mobile devices to capture screenshots from. List of supported device names can be found [here](https://www.testmuai.com/support/docs/smartui-sdk-config-options#list-of-supported-device-viewports).
