...
> **Source**: [https://www.testmuai.com/support/docs/smartui-custom-css](https://www.testmuai.com/support/docs/smartui-custom-css)

**Product**: SmartUI

**Last Crawled**: 2026-01-27T21:04:01.208126
...
Custom CSS injection is a specialized feature in SmartUI that allows you to apply test-only styles during snapshot capture without modifying your application code. This feature enables you to stabilize visual tests by normalizing dynamic content, enforcing consistent styling across environments, and masking sensitive informationâall while keeping your visual testing logic centralized and maintainable.

### Why Custom CSS Matters[â](https://www.testmuai.com/support/docs/smartui-custom-css#why-custom-css-matters "Direct link to Why Custom CSS Matters")
...
## Prerequisites[â](https://www.testmuai.com/support/docs/smartui-custom-css#prerequisites "Direct link to Prerequisites")
...
## Method 1: File Path (Recommended)[â](https://www.testmuai.com/support/docs/smartui-custom-css#method-1-file-path-recommended "Direct link to Method 1: File Path \(Recommended\)")
...
## Method 2: Embedded String[â](https://www.testmuai.com/support/docs/smartui-custom-css#method-2-embedded-string "Direct link to Method 2: Embedded String")
...
## Configuration Guidelines[â](https://www.testmuai.com/support/docs/smartui-custom-css#configuration-guidelines "Direct link to Configuration Guidelines")
  ...
  * **CSS Specificity** : Your custom CSS will be injected at snapshot time. Use `!important` declarations if you need to override existing styles. If CSS is overridden by inline styles, increase selector specificity (e.g., `.target-class` â `#specific-id .target-class`).
  ...
  * **CSS Organization** : Keep your CSS snapshot-specificâtarget only elements that need stabilization or normalization. Avoid broad selectors that might affect unintended elements.
  ...
  * **Selector Verification** : If the CSS Injection Report shows "no elements found" or "invalid selector" errors:
    ...
    * Check selector specificityâit may need to be more specific or less specific
    * Consider timing issuesâensure the element is rendered before snapshot capture
...
## Known Limitations[â](https://www.testmuai.com/support/docs/smartui-custom-css#known-limitations "Direct link to Known Limitations")
...
## Use Cases for Custom CSS[â](https://www.testmuai.com/support/docs/smartui-custom-css#use-cases-for-custom-css "Direct link to Use Cases for Custom CSS")

The custom CSS feature is particularly valuable in the following scenarios:

  * Stabilize Dynamic UI
  * Normalize Typography/Theme
  * Layout Harmonization
  * Mask PII/Identifiers
...
## Minimal Configuration Templates[â](https://www.testmuai.com/support/docs/smartui-custom-css#minimal-configuration-templates "Direct link to Minimal Configuration Templates")

### File Path Template[â](https://www.testmuai.com/support/docs/smartui-custom-css#file-path-template "Direct link to File Path Template")
...
### Embedded String Template[â](https://www.testmuai.com/support/docs/smartui-custom-css#embedded-string-template "Direct link to Embedded String Template")
...
## Additional Resources[â](https://www.testmuai.com/support/docs/smartui-custom-css#additional-resources "Direct link to Additional Resources")

  * [SmartUI CLI Documentation](https://www.testmuai.com/support/docs/smartui-cli/)
  * [SmartUI Configuration Options](https://www.testmuai.com/support/docs/smartui-cli/)
  * [Visual Regression Testing Guide](https://www.testmuai.com/support/docs/smart-visual-testing/)
  * [Layout Comparison Documentation](https://www.testmuai.com/support/docs/smartui-layout-testing/)
