...
> **Source**: [https://www.testmuai.com/support/docs/analytics-modules-test-intelligence-command-logs-analytics](https://www.testmuai.com/support/docs/analytics-modules-test-intelligence-command-logs-analytics)

**Product**: Insights

**Last Crawled**: 2026-01-27T20:47:36.647926

---

On this page

### Introduction to AI Native Command Logs Analytics[â](https://www.testmuai.com/support/docs/analytics-modules-test-intelligence-command-logs-analytics#introduction-to-ai-native-command-logs-analytics "Direct link to Introduction to AI Native Command Logs Analytics")
...
### Prerequisites for using Command Logs Analytics[â](https://www.testmuai.com/support/docs/analytics-modules-test-intelligence-command-logs-analytics#prerequisites-for-using-command-logs-analytics "Direct link to Prerequisites for using Command Logs Analytics")

The following are the steps to use Command Logs Analytics:

  1. You should have a TestMu AI account. If you don't have one, you can sign up [here](https://accounts.lambdatest.com/register).
...
### **Command Status Summary Widget** BETA[â](https://www.testmuai.com/support/docs/analytics-modules-test-intelligence-command-logs-analytics#command-status-summary-widget- "Direct link to command-status-summary-widget-")
...
### **Command Error Status Trends Widget** BETA[â](https://www.testmuai.com/support/docs/analytics-modules-test-intelligence-command-logs-analytics#command-error-status-trends-widget- "Direct link to command-error-status-trends-widget-")
...
![cmd](https://www.lambdatest.com/resources/images/errorAi.png)
...
### **Command Type Trends Widget** BETA[â](https://www.testmuai.com/support/docs/analytics-modules-test-intelligence-command-logs-analytics#command-type-trends-widget- "Direct link to command-type-trends-widget-")
...
### **Command Error Messages Categorization Widget** BETA[â](https://www.testmuai.com/support/docs/analytics-modules-test-intelligence-command-logs-analytics#command-error-messages-categorization-widget- "Direct link to command-error-messages-categorization-widget-")
...
![cmd](https://www.lambdatest.com/resources/images/commandaifold.webp)

**Use Cases** 6\. Identifying common error messages for prioritizing bug fixes 7\. Tracking the frequency of specific error messages 8\. Analyzing the proportion of error messages in the total commands 9\. Finding correlations between error message occurrences and system performance 10\. Inspecting tests with specific error messages for debugging
