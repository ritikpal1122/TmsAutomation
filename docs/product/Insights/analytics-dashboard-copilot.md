# Getting Started with AI CoPilot DashboardBETA

> **Source**: [https://www.testmuai.com/support/docs/analytics-dashboard-copilot](https://www.testmuai.com/support/docs/analytics-dashboard-copilot)

**Product**: Insights

**Last Crawled**: 2026-01-27T20:47:29.751578
...
## Prerequisites[â](https://www.testmuai.com/support/docs/analytics-dashboard-copilot#prerequisites "Direct link to Prerequisites")

To access and utilize the full potential of the AI CoPilot Dashboard, ensure that you meet the following requirements:

  1. **TestMu AI Paid Account**: You must have an active TestMu AI paid account to unlock the AI CoPilot Dashboard feature, please contact our support team at [[email protected]](https://www.testmuai.com/cdn-cgi/l/email-protection#087b7d7878677a7c487c6d7b7c657d266961).
...
To know about the widgets and how to create a dashboard, refer to the [Analytics Widgets](https://www.testmuai.com/support/docs/analytics-widgets/) documentation.

![cmd](https://www.testmuai.com/support/assets/images/dashboard-copilot-main-437bd6119b4062f8675f26e0bb0843d5.webp)

## Accessing the AI CoPilot Dashboard[â](https://www.testmuai.com/support/docs/analytics-dashboard-copilot#accessing-the-ai-copilot-dashboard "Direct link to Accessing the AI CoPilot Dashboard")
...
![cmd](https://www.testmuai.com/support/assets/images/dashboard-copilot-chat-window-155ba0615f93f37c88e0211dacd002a6.webp)

## Key Features of AI CoPilot[â](https://www.testmuai.com/support/docs/analytics-dashboard-copilot#key-features-of-ai-copilot "Direct link to Key Features of AI CoPilot")
...
![cmd](https://www.testmuai.com/support/assets/images/dashboard-copilot-chat-response-54b4fec5280d562218590f91c4181070.webp)

## AI CoPilot Dashboard Widgets[â](https://www.testmuai.com/support/docs/analytics-dashboard-copilot#ai-copilot-dashboard-widgets "Direct link to AI CoPilot Dashboard Widgets")
...
## Rate Limit and Usage Guidelines[â](https://www.testmuai.com/support/docs/analytics-dashboard-copilot#rate-limit-and-usage-guidelines "Direct link to Rate Limit and Usage Guidelines")
...
## Support and Assistance[â](https://www.testmuai.com/support/docs/analytics-dashboard-copilot#support-and-assistance "Direct link to Support and Assistance")

We understand that adopting new technologies can sometimes be challenging. If you encounter any difficulties or have questions regarding the AI CoPilot Dashboard, our dedicated support team is here to assist you. Feel free to reach out to our [24/7 customer support](https://www.testmuai.com/cdn-cgi/l/email-protection#c4b7b1b4b4abb6b084b0a1b7b0a9b1eaa5ad) for expert guidance and troubleshooting. We are committed to ensuring your success and providing you with the best possible experience while using the AI CoPilot Dashboard.
