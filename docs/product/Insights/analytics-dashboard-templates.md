...
> **Source**: [https://www.testmuai.com/support/docs/analytics-dashboard-templates](https://www.testmuai.com/support/docs/analytics-dashboard-templates)

**Product**: Insights

**Last Crawled**: 2026-01-27T20:47:34.465903

---

On this page

## About the Dashboard templates:[â](https://www.testmuai.com/support/docs/analytics-dashboard-templates#about-the-dashboard-templates "Direct link to About the Dashboard templates:")
...
## Prerequisites[â](https://www.testmuai.com/support/docs/analytics-dashboard-templates#prerequisites "Direct link to Prerequisites")
...
![cmd](https://www.testmuai.com/support/assets/images/Dashboard-Template-9097b14b807fd6e005e07a116ff2ad41.webp)

## How to use it?[â](https://www.testmuai.com/support/docs/analytics-dashboard-templates#how-to-use-it "Direct link to How to use it?")
...
## Dashboard Templates Available on the platform[â](https://www.testmuai.com/support/docs/analytics-dashboard-templates#dashboard-templates-available-on-the-platform "Direct link to Dashboard Templates Available on the platform")

### Tests Summary Report[â](https://www.testmuai.com/support/docs/analytics-dashboard-templates#tests-summary-report "Direct link to Tests Summary Report")
...
### Error Insights Report[â](https://www.testmuai.com/support/docs/analytics-dashboard-templates#error-insights-report "Direct link to Error Insights Report")
...
### Resource Consumption and Concurrency usage[â](https://www.testmuai.com/support/docs/analytics-dashboard-templates#resource-consumption-and-concurrency-usage "Direct link to Resource Consumption and Concurrency usage")
...
### All Trends Report[â](https://www.testmuai.com/support/docs/analytics-dashboard-templates#all-trends-report "Direct link to All Trends Report")
...
### OS and Browser Coverage Report[â](https://www.testmuai.com/support/docs/analytics-dashboard-templates#os-and-browser-coverage-report "Direct link to OS and Browser Coverage Report")
...
### HyperExecute Report[â](https://www.testmuai.com/support/docs/analytics-dashboard-templates#hyperexecute-report "Direct link to HyperExecute Report")
...
## Explore More Dashboard Features[â](https://www.testmuai.com/support/docs/analytics-dashboard-templates#explore-more-dashboard-features "Direct link to Explore More Dashboard Features")

  * Scheduling a Email notification of the dashboard - Read More
  * Share the Dashboard with a public or a private link with your team - [Read More](https://www.testmuai.com/support/docs/analytics-dashboard-features/#expiry-settings-for-dashboard-share-link)
  * Exporting the Dashboard as a PDF - [Read More](https://www.testmuai.com/support/docs/analytics-dashboard-features/#export-dashboard-as-pdf)
